...
namespace Paytr\Payment\Webapi\Rest\Request\Deserializer;
 ...
 *
 * @package Paytr\Payment\Webapi\Rest\Request\Deserializer
 */
class XWwwFormUrlencoded implements \Magento\Framework\Webapi\Rest\Request\DeserializerInterface
{
     ...
     *
     * @param \Paytr\Payment\Model\PostbackNotification\Decoder $decoder
     * @param State                                             $appState
     */
    public function __construct(\Paytr\Payment\Model\PostbackNotification\Decoder $decoder, State $appState)
    {
